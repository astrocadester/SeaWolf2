...
;
; Byte-exact, annotated Z80 source reconstructed from the four program ROMs.
; Required assembler: zmac 1.3
; Program ROM address space: $0000-$1FFF
;
; Sea Wolf II combines native Z80 code with DNA's TERSE direct-threaded
; execution model.  See README.md for the execution architecture, memory map,
; hardware interfaces, diagnostics, and data-format documentation.
;===============================================================================

                        INCLUDE "src/astrocade_game_seawolf2.inc"
...
SERVICE_STATION_RELOADS:
                        ...
                        LD      A,(ACTIVE_PLAYER_COUNT)
                        CP      PLAYER_COUNT_TWO
                        CALL    Z,RELOAD_STATION_AND_MINES
                        INC     C
                        INC     DE
                        LD      HL,RIGHT_TORPEDOES_REMAINING
                        CALL    RELOAD_STATION_AND_MINES
                        POP     BC
                        JP      (IY)
